function marinaraSauce(cookName) {
	...
	console.log('Add '+ oneFourth + ' cup water, ' + two + ' cans of curshed tomatoes, and salt and season with black pepper to taste.');
	console.log('Cover the pot, bring to a boil, reduce the heat to medium low, and simmer until the sauce is heated, \n about 10 minutes.');
